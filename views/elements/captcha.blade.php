@if(setting('captcha.type') === 'recaptcha')
    ...
    <div class="g-recaptcha d-flex justify-content-center" data-sitekey="{{ setting('captcha.site_key') }}" data-callback="submitCaptchaForm" data-size="invisible"></div>
...
@elseif(setting('captcha.type') === 'hcaptcha')
    ...
    <div class="h-captcha d-flex justify-content-center mb-2 @if($center ?? false) text-center @endif" data-sitekey="{{ setting('captcha.site_key') }}" @if($dark ?? false) data-theme="dark" @endif></div>
@endif
