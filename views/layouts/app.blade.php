...
<!-- CSRF Token -->
    ...
    <script src="{{ theme_asset('js/SmoothScroll.js') }}" defer></script>
    @if(Route::is('home'))
        <script src="{{ theme_asset('js/multislider.js') }}" defer></script>
        <script src="{{ theme_asset('js/home.slider.js') }}" defer></script>
    @endif
            ...
            <div class="container">
                ...
                <div class="socials">
                    <div class="social-links">
                        @foreach(['twitter', 'youtube', 'discord', 'steam', 'instagram'] as $social)
        ...
        <div class="container">
            ...
            <p style="margin-top: 10px;font-size: 10px;">
                <a class="mention" href="https://twitter.com/Captain34_dev" target="_blank">
                    Designed with <i class="fas fa-heart"></i> by Captain34, Oximov, Edited by: BluntMan420
                </a>
            </p>
        </div>
    </div>
